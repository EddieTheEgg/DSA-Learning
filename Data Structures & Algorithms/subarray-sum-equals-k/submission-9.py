    ...
    def subarraySum(self, nums: List[int], k: int) -> int:
      ...
      # Prefix Sum + Hashmap pattern:
        ...
        #remaining = [1, 3] = 4 
         ...
         # Seed {0: 1} because we sometimes don't need to chop off anything
         # nums =   [1, 3]
         # prefix = [1, 4]

         # current_sum = 4, k = 4, diff = 0 so no chop off, we have 1 added already.
        ...
        for num in nums:
            ...
            # We track how many times we've seen that prefix at the cur_sum/index
